...
/**
 * A GeodesicString consists of sequence of geodesic segments. The type
 * essentially combines a sequence of Geodesic into a single object. The
 * GeodesicString is computed from two or more positions and an interpolation
 * using geodesics defined from the geoid (or ellipsoid) of the co-ordinate
