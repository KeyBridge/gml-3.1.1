 ...
 * It is of string type, so the text can be included inline, but the value can
 * also be referenced remotely via xlinks from the AssociationAttributeGroup. If
 * the remote reference is present, then the value obtained by traversing the
 * link should be used, and the string content of the element can be used for an
 * annotation.
 * <p/>
