 ...
 * element of this type or an XLink reference to a remote time node element
 * (where remote includes elements located elsewhere in the same document). Note
 * that either the reference or the contained element must be given, but not
 * both or none.
 * <p/>
...
public class TimeNodePropertyType {
   ...
   * <p/>
   * @param value allowed object is {@link TimeNodeType }
   *
   */
