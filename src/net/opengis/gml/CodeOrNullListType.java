 ...
 * xsd:string. A member of the list may be a typed null. If a codeSpace
 * attribute is present, then its value is a reference to a Reference System for
 * the value, a dictionary or code list.
 * <p/>
...
public class CodeOrNullListType {
   ...
   * this type contains a space-separated list of Name values with null values
   * interspersed as needed Gets the value of the value property.
   * <p/>
