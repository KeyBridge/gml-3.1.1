 ...
 * elsewhere in the same document). Note that either the reference or the
 * contained element must be given, but not both or none.
 * <p/>
...
public class TimeTopologyComplexPropertyType {
   ...
   * <p/>
   * @param value allowed object is {@link TimeTopologyComplexType }
   *
   */
